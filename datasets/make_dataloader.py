...
def make_dataloader(cfg):
    train_transforms = T.Compose([
            ...
            RandomGrayscalePatchReplacement(probability=1),
    ...
    text_set = ImageDataset(dataset.train, text_transfroms)
    text_loader = DataLoader(
        text_set, batch_size=cfg.SOLVER.IMS_PER_BATCH, num_workers=num_workers,
        sampler=RandomIdentitySampler(dataset.train, cfg.SOLVER.IMS_PER_BATCH, cfg.DATALOADER.NUM_INSTANCE),
        collate_fn=train_collate_fn
    )

    return train_loader, train_loader_normal, val_loader, len(dataset.query), num_classes, cam_num, view_num, text_loader
